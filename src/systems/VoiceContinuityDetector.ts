...
export class VoiceContinuityDetector {
    ...
    /**
     * コンストラクタ
     * @param volumeThreshold - 音量閾値（デフォルト0.15に引き上げ、0-1の範囲）
     * @param maxSilentFrames - 途切れ判定フレーム数（デフォルト30フレーム = 0.5秒@60fps）
     * @param graceSeconds - 無敵時間（秒、デフォルト2秒に短縮）
     */
    constructor(volumeThreshold: number = 0.15, maxSilentFrames: number = 30, graceSeconds: number = 2) {
